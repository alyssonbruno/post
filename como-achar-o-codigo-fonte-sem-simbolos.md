...
Muitas threads duplicadas. Isso quer dizer que podemos nos focar na
...
Através das funções de RPC e OLE32 podemos concluir que se trata
...
existe apenas uma.
    ...
    STDMETHODIMP CService::Open(BYTE *fileName, COUNT keyNo, COUNT
    *pctReturn)
    {
	char szMsg[200];
