...
Ou seja, conforme chamamos a função recursivamente, a pilha tende
...
Por isso é necessário desenvolver uma segunda versão do código,
...
Como podemos ver, após n chamadas, a pilha continua apenas com uma
chamada a factorial.
